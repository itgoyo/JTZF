...
# 默认AI去广告提示词（从 .env 读取，见 DEFAULT_AI_AD_REMOVAL_PROMPT）
DEFAULT_AI_AD_REMOVAL_PROMPT = os.getenv('DEFAULT_AI_AD_REMOVAL_PROMPT', '')

# 默认AI去广告置信度阈值（从 .env 读取，0.0-1.0，见 DEFAULT_AI_AD_REMOVAL_THRESHOLD）
DEFAULT_AI_AD_REMOVAL_THRESHOLD = float(os.getenv('DEFAULT_AI_AD_REMOVAL_THRESHOLD', '0.8'))

# 默认AI改写提示词（从 .env 读取，见 DEFAULT_AI_REWRITE_PROMPT）
DEFAULT_AI_REWRITE_PROMPT = os.getenv('DEFAULT_AI_REWRITE_PROMPT', '')
