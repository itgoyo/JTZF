...
async def handle_command(client, event):
    ...
    command_handlers = {
        ...
        'append_off': lambda: handle_append_off_command(event),
        'apo': lambda: handle_append_off_command(event),
        'buttons': lambda: handle_buttons_command(event, parts),
        'bt': lambda: handle_buttons_command(event, parts),
        'buttons_off': lambda: handle_buttons_off_command(event),
        'bto': lambda: handle_buttons_off_command(event),
        'ai_translate_on': lambda: handle_ai_translate_on_command(event),
        'ato': lambda: handle_ai_translate_on_command(event),
        'ai_translate_off': lambda: handle_ai_translate_off_command(event),
        'atf': lambda: handle_ai_translate_off_command(event),
        ...
        'list_delete': lambda: handle_list_delete_command(event),
        'ld': lambda: handle_list_delete_command(event),
        ...
        'remove_delete': lambda: handle_remove_command(event, command, parts),
        'rd': lambda: handle_remove_command(event, 'remove_delete', parts),
